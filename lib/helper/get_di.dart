...
import '../features/taxi_booking/controllers/booking_checkout_controller.dart';
import '../features/taxi_booking/controllers/car_selection_controller.dart';
...
import '../features/taxi_booking/controllers/rider_controller.dart';
import '../common/controllers/theme_controller.dart';
import '../features/taxi_booking/repo/car_selection_repo.dart';
import '../features/taxi_booking/repo/cart_repo.dart';
import '../features/taxi_booking/repo/rider_repo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut<StoreRepository>(() => StoreRepository(
    apiClient: Get.find(),
    sharedPreferences: Get.find(), // هذا السطر هو الإضافة المهمة
  ));

  Get.lazyPut(() => StoreController(
    storeServiceInterface: Get.find(), // ممتاز
    storeRepo: Get.find(), // لازم تكون موجودة لأن constructor بده ياها
  ));
