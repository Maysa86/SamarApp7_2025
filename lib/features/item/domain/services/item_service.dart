...
class ItemService implements ItemServiceInterface {
  ...
  @override
  Future<List<Item>?> getPopularItemList(String type, {int? moduleId , int limit = 20,
    int offset = 1,}) async {
  ...
  @override
  Future<List<Item>?> getRecommendedItemList(String type, {int? moduleId}) async {
    return await itemRepositoryInterface.getList(type: type, isRecommendedItems: true, moduleId: moduleId);
  }
