...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  bool showAddressPopup = false; // <-- يمكنكِ تغيير القيمة لاحقًا وقت الحاجة
  ...
  Future<void> suggestAddressBottomSheet() async {
    ...
    if (showAddressPopup && widget.fromSplash &&
          ...
          body: ExpandableBottomSheet(
            background: Stack(
              children: [
                ...
                // باقي الأكواد المتعلقة بالـ Bottom Navigation
