...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  void initState() {
    super.initState();
    if (Get.find<CheckoutController>().paymentMethodIndex == -1) {
      // ✅ نعيّن الدفع نقداً كـ default إذا ما تم اختيار شيء سابقاً
      Get.find<CheckoutController>().setPaymentMethod(0);
    }
