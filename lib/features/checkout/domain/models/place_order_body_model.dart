...
class PlaceOrderBodyModel {
  ...
  int? _createNewUser;
  String? _password;
  double? _delivery_charge_zone_km;
  ...
  PlaceOrderBodyModel({
    ...
    required double? delivery_charge_zone_km,
  }) {
    _cart = cart;
    ...
    _password = password;
    _delivery_charge_zone_km = delivery_charge_zone_km;
  }
  ...
  double? get delivery_charge_zone_km => _delivery_charge_zone_km;
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    _delivery_charge_zone_km = json['delivery_charge_zone_km'] ?? 0;
  }
  ...
  Map<String, String> toJson() {
    ...
    data['delivery_charge_zone_km'] = _delivery_charge_zone_km!.toString();
