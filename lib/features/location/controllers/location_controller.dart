...
class LocationController extends GetxController implements GetxService {
  ...
  void _prepareZoneData(AddressModel address, bool fromSignUp, String? route,
    ...
    try {
      ...
      if (Get.isDialogOpen!) {
        Get.back(); // تأكد من إغلاق أي لود إذا حدث استثناء
      }
      log('❌ Error in _prepareZoneData: $e');
  ...
  void _saveDataAndFirebaseConfig(AddressModel address, bool fromSignUp,
    ...
    log('[DEBUG] ✅ Saving address and navigating to: $route');
...
//    } else {
 ...
 //   /// ✅ تأكد من الخروج من الشاشة إذا كنا داخل شاشة اختيار الموقع
  //  if (Get.currentRoute == RouteHelper.getPickMapRoute(route, false) ||
 //       Get.currentRoute.contains('pick-map')) {
 //     Get.back(); // لإغلاق شاشة PickMapScreen
 //     log('[DEBUG] ✅ Closed PickMapScreen after navigation');
 //   }
 // }
