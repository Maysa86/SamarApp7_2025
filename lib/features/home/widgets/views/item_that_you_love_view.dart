...
class _ItemThatYouLoveViewState extends State<ItemThatYouLoveView> {
  ...
  void initState() {
    ...
    // ✅ تحميل فقط إذا القائمة فاضية
    if (itemController.recommendedItemList == null || itemController.recommendedItemList!.isEmpty) {
      itemController.getRecommendedItemList(
        true,
        'all',
        false,
        moduleId: moduleId,
    ...
    _currentPage =
    itemController.recommendedItemList?.length != null &&
        itemController.recommendedItemList!.length > 1
        ? 1
        : 0;
