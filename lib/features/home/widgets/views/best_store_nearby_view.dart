                                      ...
                                      RotatedBox(
                                        ...
                                        child: Text('best_store_nearby'.tr,
                                            style: robotoBold.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeLarge),textAlign: Get.locale?.languageCode == 'ar' ? TextAlign.right : TextAlign.left,textDirection: Get.locale?.languageCode == 'ar' ? TextDirection.rtl : TextDirection.ltr,),
                                      ),
                                      Expanded(
                                        child: ListView.builder(
                                          scrollDirection: Axis.horizontal,
                                                              ...
                                                              Directionality(
                                                                ...
                                                                child: Expanded(
                                                                  ...
                                                                  child: Text(
                                                                    ...
                                                                    style: robotoMedium,
                                                                    textAlign: Get.locale?.languageCode == 'ar' ? TextAlign.end : TextAlign.start,
                                                                  ),
                                                                ),
                                                              ),
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                            ...
                                                                            style:
                                                                                robotoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                        const SizedBox(
                                                                            width:
                                                                                Dimensions.paddingSizeExtraSmall),
                                                                        Text(
                                                                            'from_you'
                                                                                .tr,
                                                                            style:
                                                                                robotoRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
