                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          ...
                                          Positioned(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Image.asset(Images.clockIcon, height: 18, width: 18, color: storeController.isOpenNow(storeList[index]) ? const Color(0xffECA507) : Theme.of(context).colorScheme.error),
                                                const SizedBox(width: 4),

                                                Text(
                                                  storeController.isOpenNow(storeList[index]) ? 'open_now'.tr : 'closed_now'.tr,
                                                  style: robotoRegular.copyWith(
                                                    color: storeController.isOpenNow(storeList[index]) ? const Color(0xffECA507) : Theme.of(context).colorScheme.error,
