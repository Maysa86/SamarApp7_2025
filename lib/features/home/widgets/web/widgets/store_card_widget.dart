      ...
      child: Stack(
        children: [
          Container(
            ...
            height: 130,
            margin: EdgeInsets.zero, // إزالة الهوامش الخارجية
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(
                                  height:
                                      5), // تقليل المسافة بين الوقت والتقييم
                              Row(
                                children: [
                                  Icon(Icons.star,
                                      size: 15,
...
// ✅ قائمة المتاجر مع إزالة المسافات الكبيرة وإضافة الخط الفاصل بين المتاجر
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Column(
          children: [
            StoreCardWidget(store: stores[index]), // عنصر المتجر

            if (index != stores.length - 1) // إضافة خط فاصل بين المتاجر
