...
import '../../../helper/rider_type.dart';
import '../../../util/dimensions.dart';
import '../../../common/widgets/custom_app_bar.dart';
import '../../../common/widgets/custom_button.dart';
import 'widgets/rider_address_input_field.dart';
...
class _SelectMapLocationState extends State<SelectMapLocation> {
  ...
  void initState() {
    ...
    if (kDebugMode) {
      log('-------rider type : ${widget.riderType}/ ${widget.address}');
    }
  ...
  Widget expandableContent(
    ...
    if (kDebugMode) {
      log("===----- rider type name : ${riderType.name}");
    }
    switch (riderType) {
      ...
      default:
        return GetBuilder<RiderController>(builder: (riderController) {
          if (kDebugMode) {
            log('-----------= : ${riderController.toAddress == null} / ${riderController.toTextEditingController.text == ''}');
          }
          return Container(
            height: 85,
            color: Theme.of(context).cardColor,
